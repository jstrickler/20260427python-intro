...
import magic  # module to determine attachment type (install as python-magic-bin)
...
def add_attachment(file_path, message):
    with open(file_path, 'rb') as file_in:  # read data for text or binary attachment
    ...
    # add attachment to message, including type and subtype (e.g., "image/jpg)"
